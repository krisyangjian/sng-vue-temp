<template>
	<div>
		...
		<v-dialog @before-opened="dialogEvent('before-open')" @before-closed="dialogEvent('before-close')" @opened="dialogEvent('opened')" @closed="dialogEvent('closed')" />

		<modal name="example-modal" transition="nice-modal-fade" :min-width="200" width="500" :height="500" :min-height="200" :delay="100" :adaptive="adaptive" :resizable="resizable" :draggable="draggable">
    ...
    Vue.use(vmodal)
		...
		<div style="margin-top: 20px; margin-bottom: 15px;">
			<el-button type="primary" @click="show(false, false, false)">Simple</el-button>
			<el-button type="primary" @click="show(true, false, false)">Resizable</el-button>
			<el-button type="primary" @click="show(false, true, false)">Adaptive</el-button>
			<el-button type="primary" @click="show(false, false, true)">Draggable</el-button>
			<br>
			<el-button type="primary" @click="$modal.show('dog-profile')">
      Demo: Dog Profile photo
    </el-button>
			<el-button type="primary" @click="$modal.show('error-modal')">
      Demo: Error handling
    </el-button>
			<el-button type="primary" @click="$modal.show('demo-login')">
      Demo: Login
    </el-button>
			<el-button type="primary" @click="$modal.show('size-modal')">
      create-modal
    </el-button>
			<el-button :class="canBeShown ? 'btn green' : 'btn red'" @click="conditionalShow">
      ...
      Dialog: basic
			...
			<el-button type="primary" @click="showTitleDialog">
      Dialog: title
    </el-button>

			<el-button type="primary" @click="showButtonsDialog">
      Dialog: buttons
    </el-button>
		</div>
	</div>
